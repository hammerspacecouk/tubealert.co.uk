class SubscriptionsController {
  ...
  subscribeAction(event) {
    ...
    return this.subscription
      .subscribeUser(userID, lineID, timeSlots, subscription, this.dateTimeHelper.getNow())
      .then(() => {
    ...
    return this.subscription
      ...
      .then(removedCount => {
        ...
        return this.callback(
          null,
          this.jsonResponseHelper.createResponse({
            status: "success",
  ...
  fail(err) {
    ...
    return this.callback(true, this.jsonResponseHelper.createErrorResponse("Failed to perform action"));
  }
}
