...
const createController = (mockCallback, b, c, d, e, f, g) => new DataController(
    ...
    d || mockStatusModel,
    e || mockSubscriptionModel,
    f || mockNotificationModel,
    g || mockLogger
);
...
test("fetchAction creates notifications", () => {
    ...
    const ctl = createController(mockCallback, null, null, mockStatusModel, mockSubscriptionsModel, mockNotificationModel);
