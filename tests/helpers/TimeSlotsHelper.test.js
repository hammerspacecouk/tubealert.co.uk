    ...
    expect(result).toEqual([
        {
            PutRequest : {
                Item: {
                    UserID: "endpoint", LineSlot: "line_0201", Line: "line", Day: 2, Hour: 1,
                    WindowStart: 1, Created: "now", Subscription: {endpoint: "endpoint"}
                }
            }
        },
        {
            PutRequest: {
                Item: {
                    UserID: "endpoint", LineSlot: "line_0203", Line: "line", Day: 2, Hour: 3,
                    WindowStart: 3, Created: "now", Subscription: {endpoint: "endpoint"}
                }
            }
        },
        {
            PutRequest: {
                Item: {
                    UserID: "endpoint", LineSlot: "line_0204", Line: "line", Day: 2, Hour: 4,
                    WindowStart: 3, Created: "now", Subscription: {endpoint: "endpoint"}
                }
            }
        },
        {
            PutRequest: {
                Item: {
                    UserID: "endpoint", LineSlot: "line_0205", Line: "line", Day: 2, Hour: 5,
                    WindowStart: 3, Created: "now", Subscription: {endpoint: "endpoint"}
                }
            }
        },
